...
C10 — Pre-Action Gate for Sensitive Pipeline Configuration
...
This check COMPLEMENTS the C6 permission policy (CLAUDE.md §11, ASK tier)
...
def main() -> int:
    ...
    # Also print a short version to stdout for Claude's context window
    ...
    return 2  # Non-zero exit blocks the tool call in Claude Code
